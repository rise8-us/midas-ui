...
import { CreateOrUpdatePortfolioPopup } from './index'

describe('<CreateOrUpdatePortfolioPopup />', () => {
    ...
    test('should render properly', async() => {
        render(<CreateOrUpdatePortfolioPopup />)
    ...
    test('should display error messages', async() => {
        ...
        render(<CreateOrUpdatePortfolioPopup />, { initialState: state })
    ...
    test('should call onSubmit for updatePortfolio', async() => {
        ...
        render(<CreateOrUpdatePortfolioPopup id = {4} />)

        const name = 'My Edited Portfolio'
        const description = 'New description'

        const nameInput = screen.getByTestId('CreateOrUpdatePortfolioPopup__input-name')
        const descriptionInput = screen.getByTestId('CreateOrUpdatePortfolioPopup__input-description')
