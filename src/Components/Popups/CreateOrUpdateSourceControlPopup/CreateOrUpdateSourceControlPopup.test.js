...
import { CreateOrUpdateSourceControlPopup } from './index'

describe('<CreateOrUpdateSourceControlPopup />', () => {
    ...
    test('should render properly for createSourceControl', () => {
        render(<CreateOrUpdateSourceControlPopup />)
    ...
    test('should render properly for updateSourceControl', () => {
        ...
        render(<CreateOrUpdateSourceControlPopup id = {4}/>)
    ...
    test('should display error messages', () => {
        ...
        render(<CreateOrUpdateSourceControlPopup />, { initialState: state })
    ...
    test('should call onSubmit to Update sourceControl', () => {
        ...
        const nameInput = screen.getByTestId('CreateOrUpdateSourceControlPopup__input-name')
        const descriptionInput = screen.getByTestId('CreateOrUpdateSourceControlPopup__input-description')
        const baseUrlInput = screen.getByTestId('CreateOrUpdateSourceControlPopup__input-baseUrl')
        const tokenInput = screen.getByTestId('CreateOrUpdateSourceControlPopup__input-token')
